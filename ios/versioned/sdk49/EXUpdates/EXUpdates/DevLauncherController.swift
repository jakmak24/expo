 ...
 *
 * Implements the ABI49_0_0EXUpdatesExternalInterface from the expo-updates-interface package. This allows
 * expo-dev-client to compile without needing expo-updates to be installed.
 */
@objc(ABI49_0_0EXUpdatesDevLauncherController)
@objcMembers
public final class DevLauncherController: NSObject, UpdatesExternalInterface {
  private static let ErrorDomain = "ABI49_0_0EXUpdatesDevLauncherController"
  ...
  public weak var bridge: AnyObject? {
    ...
    set(value) {
      _bridge = value
      if let value = value as? ABI49_0_0RCTBridge {
